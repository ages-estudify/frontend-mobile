...
export function SubscriptionPaywallInline() {
    ...
    <View className="flex-1 flex-col items-center justify-center gap-6 px-8">
      ...
      <View>
        ...
        <Text className="max-w-[320px] text-center font-inter text-[13px] leading-5 text-primaryGray">
          Assine um plano e acesse treinos, simulados, acompanhe seu progresso e crie seu cronograma
          de estudos aqui mesmo!
        </Text>
      </View>
      <Pressable
        testID="planos"
