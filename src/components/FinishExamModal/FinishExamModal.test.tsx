...
describe("FinishExamModal", () => {
  ...
  it("should disable buttons when loading", () => {
    ...
    // While loading, the confirm button keeps its "Confirmar" label and the
    // cancel button shows "Finalizando..."; both are disabled.
    const confirmButton = screen.getByText("Confirmar");
    const cancelButton = screen.getByText("Finalizando...");
